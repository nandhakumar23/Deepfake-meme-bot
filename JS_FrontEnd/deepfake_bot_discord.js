    ...
    if(msg.content.includes('setvid'))
    {
        ...
        download(msg.attachments.array()[0].url,filename,function () {
            ...
            try {
                ...
                console.log("here1");
                execSync(
                    "cd C:\\Users\\Nandhakumar\\Documents\\GitHub\\Deepfake-meme-bot\\PY_BackEnd\\first-order-model\\ && python C:\\Users\\Nandhakumar\\Documents\\GitHub\\Deepfake-meme-bot\\PY_BackEnd\\first-order-model\\driving_code_disc.py"
                );

                console.log("here2");
                execSync(
                    'C:\\Users\\Nandhakumar\\AppData\\Local\\imageio\\ffmpeg\\ffmpeg-win32-v3.2.4.exe -i C:\\Users\\Nandhakumar\\Documents\\GitHub\\Deepfake-meme-bot\\PY_BackEnd\\first-order-model\\disc_out.mp4 -r 30 -filter:v "setpts=PTS/3" C:\\Users\\Nandhakumar\\Documents\\GitHub\\Deepfake-meme-bot\\PY_BackEnd\\first-order-model\\disc_out_fps.mp4 -y'
                );

                console.log("here3");
                execSync(
                    "C:\\Users\\Nandhakumar\\AppData\\Local\\imageio\\ffmpeg\\ffmpeg-win32-v3.2.4.exe -i C:\\Users\\Nandhakumar\\Documents\\GitHub\\Deepfake-meme-bot\\PY_BackEnd\\first-order-model\\disc_out_fps.mp4 -i C:\\Users\\Nandhakumar\\Documents\\GitHub\\Deepfake-meme-bot\\JS_FrontEnd\\disc_vid.mp4 -c copy -map 0:v0 -map 1:a0 -shortest C:\\Users\\Nandhakumar\\Documents\\GitHub\\Deepfake-meme-bot\\PY_BackEnd\\first-order-model\\disc_final.mp4 -y"
                );
                ...
                msg.channel.send("Done! ",{
                    files: [{
                        attachment: 'C:\\Users\\Nandhakumar\\Documents\\GitHub\\Deepfake-meme-bot\\PY_BackEnd\\first-order-model\\disc_final.mp4',
                        name: 'disc_final.mp4'
                    }]
                })
                    .then(console.log)
